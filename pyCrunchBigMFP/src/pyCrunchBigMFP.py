...
Crunch the huge MPF dataset.

==========
Background
==========

MFP dropped a half a million meals worth of data.
Data was a Tab Separated file with json data in the third column.
pyConvertDiary reduced this data.
This program further reduces the data.

=====
Usage
=====

This program prompts for the input file.
The output file is created in the same path with as pyCrunchBigMFP-YY-MM-DD.csv
...
class ControlClass:
	...
	def crunchServingsList(self, servingsList):
		...
		User,Date,Meal_Name,Meal_Number,Dish_Name,Dish_Number,Protein,Carbs,Fat
		1,2014-09-14,MY food,1,"my - McDonalds Espresso Pronto Flat White, 2 TALL",1,21,29,24
		1,2014-09-14,MY food,1,"Quest Bar - Banana Nut Muffin Natural Protein Bar, 60 g",2,20,25,5
		1,2014-09-15,MY food,1,"my - McDonalds Espresso Pronto Flat White, 2 TALL",1,21,29,24
		"""
...
class UIManager:
	...
	def __init__(self):
		...
		window.set_title('pyCrunchBigMFP - Kicad Parts List creation program')

		# Create an ActionGroup
		actiongroup =	gtk.ActionGroup("pyCrunchBigMFP")
		...
		self.actiongroup.add_actions([
									...
									("File", None, "_File"),
									("Help", None, "_Help"),
									("About", None, "_About", None, "About pyCrunchBigMFP", self.about_pyCrunchBigMFP),
									])
	...
	def about_pyCrunchBigMFP(self, b):
		"""The about dialog
		"""
		message = gtk.MessageDialog(type=gtk.MESSAGE_INFO, buttons=gtk.BUTTONS_OK)
		message.set_markup("About pyCrunchBigMFP\n(c) 2014 - Doug Gilliland\nAAC - All rights reserved\npyCrunchBigMFP Create a mediawiki table frm a CV file")
		message.run()
		message.destroy()
		return
