...
Learned to use matplotlab for this assignment. 

That let me plot a scatter diagram of the pixel x,y coordinates.

Key insight was that the pixels started out at a large distance which eventually converged.

Calculated the bounding box (upper left to lower right) around the most extreme pixels. 
When the bounding box was minimal, I printed a message on the screen and went back to the
location prior to that location. I actually went back several to see where it happened.

Got an ob1 on the part 2 but they told me I was too low so I just added one second and it worked.

Saved images of the solution in github folder.
