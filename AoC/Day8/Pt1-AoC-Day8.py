...
class filer():
	...
	def loadList(self,filename):
		readTextFileToList(filename):

	def getNextNodeFromList(self):
		nextNode = [inputList[inFileListOff],inputList[inFileListOff+1],inputList[inFileListOff+2],inputList[inFileListOff+3]]
		inFileListOff += 4
		return [nextNode]
